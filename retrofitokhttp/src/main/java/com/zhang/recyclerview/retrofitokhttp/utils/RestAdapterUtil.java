package com.zhang.recyclerview.retrofitokhttp.utils;

import android.content.Context;

import com.squareup.okhttp.Cache;
import com.squareup.okhttp.OkHttpClient;
import com.zhang.recyclerview.retrofitokhttp.MvpApplication;
                ...
                .setRequestInterceptor(new RequestInterceptor() {
                                           ...
                                           public void intercept(RequestFacade request) {
                                               request.addQueryParam("deviceid",
                                                       DeviceUtil.getIEMI(ctx));
                                               if (NetworkUtil.isNetworkAvaliable(ctx)) {
    ...
    public static <T> T getRestAPI(String endpoint, final Class<T> service) {
        ...
        RestAdapter restAdapter = new RestAdapter.Builder()
                ...
                .setRequestInterceptor(new RequestInterceptor(){
                    @Override
                    public void intercept(RequestFacade request) {
                        request.addQueryParam("deviceid", DeviceUtil.getIEMI(MvpApplication.getInstance()));
                    }
                })
